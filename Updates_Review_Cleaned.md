...
This is the complete, corrected, fully aligned summary with nothing omitted or dropped. You can now proceed to implement 3D (109) first, then the rest in the order above.
