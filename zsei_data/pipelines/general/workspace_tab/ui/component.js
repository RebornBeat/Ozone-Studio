  ...
  render: function (container, props, React, ReactDOM) {
        ...
        try {
          ...
          if (window.ozone?.orchestrate) {
            const result = await window.ozone.orchestrate({
              ...
              token_budget: 100000,
              context_scope: projectId ? "Project" : "Workspace",
            });
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Context: " + projectName + " files & URLs",
          ),
        ),
          ...
          messages.length === 0
            ? React.createElement(
                ...
                React.createElement(
                  "p",
                  null,
                  "Start chatting within this project's context",
                ),
                React.createElement(
                  "p",
                  { className: "empty-hint" },
                  "Your questions will use linked files and URLs as context",
                ),
              )
            : messages.map((msg) =>
                React.createElement(
                  "div",
                  { key: msg.id, className: "chat-message " + msg.role },
                  React.createElement(
                    "div",
    ...
    function WorkspaceUI() {
      ...
      const handleLinkFile = async () => {
        ...
        if (!path) return;
        try {
          const result = await executePipeline(30, {
            action: "Link",
            project_id: projId,
            file_path: path,
            analyze: true,
      ...
      if (selectedProject) {
        ...
        const wsId = selectedWorkspace?.id || selectedWorkspace?.workspace_id;
        const fileCount =
          selectedProject.file_count ?? selectedProject.files_count ?? 0;
        ...
        return React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "button",
                { className: "toolbar-btn", onClick: handleLinkFile },
                "📎 Link File",
              ),
              React.createElement(
                "button",
          ...
          files.length === 0
            ? React.createElement(
                "div",
                { className: "panel-empty-centered" },
                React.createElement("span", { className: "empty-icon" }, "📂"),
                React.createElement("p", null, "No linked content yet"),
                React.createElement(
                  "p",
                  { className: "empty-hint" },
                  "Link files or URLs to build this project's context",
                ),
              )
            : React.createElement(
                "div",
                        ...
                        onClick: async (e) => {
                          ...
                          try {
                            await executePipeline(30, {
                              action: "Unlink",
                              project_id: projId,
                              file_ref_id: file.file_ref_id || file.id,
                            });
                            loadProjectFiles(projId);
                          } catch (err) {
            ...
            workspaces.map((ws) => {
              ...
              return React.createElement(
                "div",
                {
                  key: wsId,
                  className:
                    "workspace-item" + (selectedId === wsId ? " selected" : ""),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              null,
              "A ",
              React.createElement("strong", null, "Workspace"),
